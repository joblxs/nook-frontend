...
.navigation, .navigation_close, .navigation_open {
    width: 100%;
    height: 100%;
    position: fixed;
    z-index: 101
...
.navigation:before, .navigation_close:before, .navigation_open:before {
    content: '';
    width: 60%;
    height: 100%;
    background: #fff;
    ...
    top: 0;
    z-index: 11;
    background-image: -webkit-linear-gradient(46deg, #2f4d25, #f1f2f0);
    background-image: -moz-linear-gradient(46deg, #2f4d25, #f1f2f0);
    background-image: -o-linear-gradient(46deg, #2f4d25, #f1f2f0);
    background-image: linear-gradient(46deg, #2f4d25, #f1f2f0)
}
...
.navigation_open .navigation-point {
    display: block
}

.navigation_close .navigation-point {
    display: none
}
...
.navigation_open .navigation-logo {
    display: block
}

.navigation_close .navigation-logo {
    display: none
}

@media screen and (max-width: 768px) {
    .navigation:before, .navigation:before, .navigation_close:before {
        width: 50%;
        transform: none;
